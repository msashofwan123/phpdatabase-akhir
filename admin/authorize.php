...
<head>
  ...
  <title>Inspira Media - User Control</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">User Control</h1>
            <ol class="breadcrumb">
                        ...
                        <tr>
                          ...
                          <td><?php
                              if ($data['status'] == 1) {
                                ...
                                echo "Belum Teraktivasi";
                              }
                              ?></td>
                          <td>
                            <button class="btn btn-info btn-edit" data-bs-toggle="modal" data-bs-target="#editdata" data-id="<?= $data['id'] ?>" data-bs-aksi="ubah">Ubah</button>
                            <button class="btn btn-danger btn-delete" data-bs-toggle="modal" data-id="<?= $data['id'] ?>">Hapus</button>
                          </td>
                        </tr>
                      <?php
                      }

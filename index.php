...
<head>
    ...
    <title>Apotek Inspira Media</title>
...
<body>
    ...
    <div id="home-container">
        ...
        <div id="illustration">
            <img src="assets/svg/price.svg" alt="dash img" id="dash" class="crypto-icons">
            <img src="assets/svg/obat.svg" alt="iota img" id="iota" class="crypto-icons">
            <img src="assets/svg/original.svg" alt="eth img" id="eth" class="crypto-icons">
            <img src="assets/svg/monitor.svg" alt="monitor img" id="monitor">
        </div>
